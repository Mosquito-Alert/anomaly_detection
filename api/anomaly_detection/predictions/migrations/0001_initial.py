    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('success_percentage', models.FloatField(default=0, help_text='The percentage of success of the execution.', verbose_name='Success percentage')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('predictor', models.ForeignKey(help_text='The predictor which has the model and the predicted values associaded to the metric.', on_delete=django.db.models.deletion.RESTRICT, related_name='metrics', to='predictions.predictor', verbose_name='Predictor')),
            ],
            options={
                'verbose_name': 'Metric',
